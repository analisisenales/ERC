# -*- coding: utf-8 -*-
"""
KNN sin biomarcadores principales.
Enfoque: Búsqueda de pacientes similares usando solo biomarcadores secundarios
"""
...
# Paso 2: Generación de la "Ground Truth" o variable objetivo basada en la fórmula eGFR.
# Se conservan únicamente los registros con los datos necesarios para el cálculo.
...
# Paso 3: Preparación de datos previniendo la fuga de datos (Data Leakage).
# Se excluyen las variables directas utilizadas en el cálculo de eGFR.
columnas_excluir = [
    'ID_Participante', 
    'Target_Estadio', 
    'eGFR_Real', 
...
# B. Escalamiento de características para homogeneizar la magnitud matemática.
scaler = StandardScaler()
X_train_scaled = scaler.fit_transform(X_train_imputed)
X_test_scaled = scaler.transform(X_test_imputed)

# Paso 5: Inicialización y entrenamiento del modelo clasificador KNN.
print("🧠 Entrenando KNN ciego (calculando distancias entre pacientes)...")
knn_model = KNeighborsClassifier(n_neighbors=5) 
knn_model.fit(X_train_scaled, y_train)

# Paso 6: Evaluación del modelo, cálculo de métricas de rendimiento y visualización.
y_pred = knn_model.predict(X_test_scaled)

print("\n" + "="*50)
accuracy = accuracy_score(y_test, y_pred)
print(f"🏆 PRECISIÓN (ACCURACY) KNN Ciego: {accuracy * 100:.2f}%")
print("="*50)
print("\n📋 Reporte Detallado:")
print(classification_report(y_test, y_pred))

# Generación de la Matriz de Confusión para análisis visual.
...
plt.title(f'Matriz de Confusión KNN (Modelo Ciego)\nPrecisión: {accuracy:.2f}')
