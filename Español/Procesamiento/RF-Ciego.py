# -*- coding: utf-8 -*-
"""
Random Forest sin biomarcadores principales.
Enfoque: Descubrimiento de biomarcadores alternativos para predicción de ERC mediante un modelo a ciegas.
"""
...
# Se conservan los registros con los datos clave únicamente para el proceso de validación (test).
...
# Se excluyen explícitamente las variables de cálculo directo para forzar al modelo a predecir
# utilizando exclusivamente los biomarcadores secundarios.
columnas_excluir = [
    'ID_Participante', 
    'Target_Estadio', 
    'eGFR_Real', 
...
print("\n🛠️ Rellenando valores faltantes en biomarcadores secundarios...")
...
print("🧠 Entrenando IA ciega (buscando relaciones ocultas en datos sanguíneos)...")
...
print(f"🏆 PRECISIÓN (ACCURACY) Random Forest Ciego: {accuracy * 100:.2f}%")
print("="*50)
print("\n📋 Reporte Detallado:")
