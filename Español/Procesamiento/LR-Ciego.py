# -*- coding: utf-8 -*-
"""
Regresión Logística sin biomarcadores principales.
Enfoque: Descubrimiento de biomarcadores alternativos para predicción de ERC mediante un modelo lineal ciego.
"""
...
# Se conservan los registros con los datos clave únicamente para generar la calificación correcta.
...
# Paso 3: Preparación de datos para Machine Learning previniendo la fuga de datos (Data Leakage).
columnas_excluir = [
    'ID_Participante', 
    'Target_Estadio', 
    'eGFR_Real', 
...
print("\n🛠️ Rellenando valores faltantes y escalando biomarcadores secundarios...")

# A. Imputación de valores faltantes (usamos matrices directas por eficiencia computacional)
...
print("🧠 Entrenando Regresión Logística ciega (buscando relaciones estadísticas ocultas)...")
...
print(f"🏆 PRECISIÓN (ACCURACY) Regresión Logística Ciega: {accuracy * 100:.2f}%")
print("="*50)
print("\n📋 Reporte Detallado:")
...
# Aquí es donde aprovechamos X.columns que guardamos intacto desde el Paso 3
...
sns.barplot(x='Importancia', y='Biomarcador', data=df_importancia, palette='crest')
plt.title('Descubrimiento de Biomarcadores Alternativos para ERC\n(Regresión Logística sin biomarcadores principales)', fontsize=14)
plt.xlabel('Magnitud del Coeficiente (Importancia Estadística)', fontsize=12)
